...
from testando_telegram import enviar_mensagem_telegram
...
def get_cost(event, context):
    ...
    resposta = cliente_ce.get_cost_and_usage(
            TimePeriod={
                'Start' : data_inicial,
                'End' : data_final  # ele nao considera este ultimo, igual corte de listas no python
            },
            Granularity='MONTHLY',
            Metrics=[
                'AmortizedCost'
    ...
    mensagem = f'O custo da AWS este mês está em USD $ {valor}.'
